...
好吧，以上都是我YY的，言归正传。我们平时在业务开发中，除了上面的应用场景还有很多，如：对接三方接口服务出错、阈值触发、异常请求等业务相关需要报警的场景有很多。干脆索性就想搞一个能在生活中**任何时候实时主动通知**我的玩意儿，短信？电话？但要成本啊，就想到我们每天都不离手的微信。然后通知的方式既不想对代码有太大的侵入性，又想实现起来简单优雅，还想要兼容以前的代码，于是想到了日志框架打日志的方式。于是，weixin+ log = wxLog 诞生了！
